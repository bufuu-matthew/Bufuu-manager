...
export class Backend implements backendInterface {
    ...
    async createAccount(arg0: SocialMediaAccount): Promise<AccountId> {
        if (this.processError) {
            try {
    ...
    async createMessage(arg0: Message): Promise<MessageId> {
        if (this.processError) {
            try {
                const result = await this.actor.createMessage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createPost(arg0: Post): Promise<PostId> {
        if (this.processError) {
            try {
    ...
    async deleteAccount(arg0: AccountId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAccount(arg0: AccountId): Promise<SocialMediaAccount> {
        if (this.processError) {
            try {
    ...
    async getMessage(arg0: MessageId): Promise<Message> {
        if (this.processError) {
            try {
    ...
    async listAccounts(arg0: AccountId): Promise<Array<SocialMediaAccount>> {
        if (this.processError) {
            try {
                const result = await this.actor.listAccounts(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listMessages(arg0: bigint, arg1: bigint): Promise<Array<Message>> {
        if (this.processError) {
            try {
                const result = await this.actor.listMessages(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listMessagesByAccount(arg0: AccountId): Promise<Array<Message>> {
        if (this.processError) {
            try {
                const result = await this.actor.listMessagesByAccount(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markMessageRead(arg0: MessageId, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
    ...
    async markMessageStarred(arg0: MessageId, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markMessageStarred(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateAccountStatus(arg0: AccountId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateAccountStatus(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePostStatus(arg0: PostId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePostStatus(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
